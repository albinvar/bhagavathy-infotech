            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Supplier Transaction History</h4>
                    </div>
                </div>
            </div>     
            <!-- end page title --> 
                    ...
                    <div class="card">
                        <div class="card-body">
                            <table class="table w-100 borderless" style="margin-bottom: 0px;">
                                <tr>
                                    <td>Supplier Name </td>
                                    <td><b>: <?= $supplierdet->sp_name ?></b></td>
                                
                                    <td>Phone</td>
                                    <td><b>: 
                                        <?php 
                                                $pharr = array();
                                                if($supplierdet->sp_contactnumber != "")
                                                {
                                                    $pharr[] = $supplierdet->sp_contactnumber;
                                                }
                                                if($supplierdet->sp_mobile != "")
                                                {
                                                    $pharr[] = $supplierdet->sp_mobile;
                                                }
                                                echo implode(', ', $pharr);
                                                ?>
                                    </b></td>
                                    ...
                                    <td><b>: <?php 
                                                        ...
                                                        echo $supplierdet->sp_gstno;
                                                    
                                                    ?></b></td>
                                
                                    <td>Balance</td>
                                    <td><b>: <?= price_roundof($supplierdet->sp_balanceamount) ?></b></td>
                                </tr>
                            </table>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <script type="text/javascript">
                                function filterproducthistory()
                                {
                                    ...
                                    window.location.href= '<?= base_url() ?>business/supplierpayhistory/<?= $supplierid ?>/'+fromdate+'/'+todate;
                                }
                            </script>
                                ...
                                <div class="tab-pane active" id="billtab">
                                    <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                        ...
                                        <tbody>
                                            ...
                                            if(!empty($purchasebills))
                                            {
                                                $k=1;
                                                foreach($purchasebills as $stvl)
                                                {
                                                    ?>
                                                    <tr>
                                                        <td><?= $k ?></td>
                                                        ...
                                                        <td><?php echo $stvl->pm_grandtotal;
                                                        $totamount = $totamount + $stvl->pm_grandtotal;
                                                         ?></td>
                                                        
                                                        <td><?php echo $stvl->pm_paidamount;
                                                        $totpaid = $totpaid + $stvl->pm_paidamount;
                                                         ?></td>
                                                        <td><?= $stvl->pm_grandtotal - $stvl->pm_paidamount ?></td>
                                                        <td>
                                                            <a href="<?= base_url() ?>purchase/purchaseprint/<?= $stvl->pm_purchaseid ?>/0" target="_blank" class="text-primary"><i class="fas fa-print"></i> Print</a>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                    $k++;
