                ...
                <div class="col-12">
                    <div class="page-title-box">
                        <div class="page-title-right">
                            ...
                            <a href="<?= base_url() ?>reports/itemwisereportcsv/<?= $type ?>/<?= $fromdate ?>/<?= $todate ?>" class="ms-1">
                            ...
                            <a href="<?= base_url() ?>reports/itemwisereport/<?= $type ?>/<?= $fromdate ?>/<?= $todate ?>/1"  target="_blank" class="ms-1">
                        ...
                        <div class="card-body">
                            ...
                            <script type="text/javascript">
                                function filterstockfun()
                                {
                                    ...
                                    window.location.href= '<?= base_url() ?>reports/itemwisereport/'+type+'/'+fromdate+'/'+todate;
                                }
                            </script>
