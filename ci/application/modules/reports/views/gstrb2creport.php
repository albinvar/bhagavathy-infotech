                ...
                <div class="col-12">
                    <div class="page-title-box">
                        <div class="page-title-right">
                            ...
                            <a href="<?= base_url() ?>reports/gstrb2creportcsv/<?= $fromdate ?>/<?= $todate ?>" class="ms-1">
                        ...
                        <div class="card-body">
                            ...
                            <script type="text/javascript">
                                function filterstockfun()
                                {
                                    ...
                                    window.location.href= '<?= base_url() ?>reports/gstrb2creport/'+fromdate+'/'+todate;
                                }
                            </script>
