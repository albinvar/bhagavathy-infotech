...
if($newprint == 1)
{
    if($type == 1)
    {
        ...
        ?>
        <a href="<?= base_url() ?>rawmaterial/purchasehistory/1"><button class="printButtonClass">Back</button></a>
        <?php
    }else{
        ?>
        <a href="<?= base_url() ?>rawmaterial/purchasehistory"><button class="printButtonClass">Back</button></a>
        <?php
    }
}
?>
