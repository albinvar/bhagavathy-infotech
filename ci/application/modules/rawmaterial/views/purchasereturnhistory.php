                ...
                <div class="col-12">
                    <div class="page-title-box">
                        <div class="page-title-right">
                            ...
                            <a href="<?= base_url() ?>rawmaterial/dashboard/0" class="ms-1 finyearaddbutton">
                                <button type="button" class="btn btn-primary waves-effect waves-light listbtns"><i class="fas fa-plus-circle"></i> Puchase Materials</button>
                            </a>

                            
                                
                        </div>
                        <h4 class="page-title">Material Purchase Returns History</h4>
                    </div>
                </div>
            </div>     
            <!-- end page title --> 
                        ...
                        <div class="card-body">
                            ...
                            <script type="text/javascript">
                                function filterstockfun()
                                {
                                    ...
                                    window.location.href= '<?= base_url() ?>rawmaterial/purchasereturns/'+supplierid+'/'+fromdate+'/'+todate;
                                }
                            </script>
                                    ...
                                    if($purchaselist)
                                    {
                                        ...
                                        foreach($purchaselist as $stvl)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $stvl->sp_name ?></td>
                                                <td><?= date('d-M-Y H:i', strtotime($stvl->pm_returnedon)) ?></td>
                                                ...
                                                <td>
                                                    <a href="<?= base_url() ?>rawmaterial/purchasereturnprint/<?= $stvl->pm_purchaseid ?>" target="_blank" class="text-primary"><i class="fas fa-print"></i> Print</a> &nbsp;
