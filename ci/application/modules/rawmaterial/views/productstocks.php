                ...
                <div class="col-12">
                    <div class="page-title-box">
                        <div class="page-title-right">
                            ...
                            <a href="<?= base_url() ?>rawmaterial/productstocks/0/<?= $categoryid ?>/1"  target="_blank" class="ms-1">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <a href="<?= base_url() ?>rawmaterial/productbatchwisestock" class="btn <?php if($active == '1'){ echo "btn-primary"; }else{ echo "btn-light"; } ?>" data-toggle="tab">Batch Wise Report</a>

                                    <a href="<?= base_url() ?>rawmaterial/productstocks/0" class="btn <?php if($active == '0'){ echo "btn-primary"; }else{ echo "btn-light"; } ?> " data-toggle="tab">Products Stock</a>
                            ...
                            <script type="text/javascript">
                                function filterproducthistory()
                                {
                                    ...
                                    window.location.href= '<?= base_url() ?>rawmaterial/productstocks/0/'+categoryid;
                                }
                            </script>
