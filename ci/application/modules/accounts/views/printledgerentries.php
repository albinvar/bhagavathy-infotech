...
<table border="1" width="100%" style="border-collapse: collapse; font-size: 13px;" cellpadding="5" cellspacing="0">
    ...
    <tfoot>
        <tr>
            <th colspan="3">Total Debit: <b><?= $totdebit ?></b></th>
            <th colspan="3">Total Credit: <b><?= $totcredit ?></b></th>
            
            <th colspan="2">Closing Balance: <b><?= $closingbalance ?></b></th>
