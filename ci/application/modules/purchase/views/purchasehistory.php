                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            ...
                            <a href="<?= base_url() ?>purchase/dashboard" class="ms-1 finyearaddbutton">
                                <button type="button" class="btn btn-primary waves-effect waves-light listbtns"><i class="fas fa-plus-circle"></i> Add Purchase</button>
                            </a>
                            <?php 
                            }else{
                                ?>
                                <a href="<?= base_url() ?>purchase/dashboard/1" class="ms-1 finyearaddbutton">
                        ...
                        <div class="card-body">
                            ...
                            <script type="text/javascript">
                                function filterstockfun()
                                {
                                    ...
                                    window.location.href= '<?= base_url() ?>purchase/purchasehistory/<?= $type ?>/'+supplierid+'/'+fromdate+'/'+todate;
                                }
                            </script>
                                    ...
                                    if($purchaselist)
                                    {
                                        ...
                                        foreach($purchaselist as $stvl)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= base_url() ?>purchase/purchaseprint/<?= $stvl->pm_purchaseid ?>/<?= $type ?>" target="_blank" class="text-primary"><i class="fas fa-print"></i> Print</a> &nbsp;
                                                    <?php 
                                                    ...
                                                    <a href="<?= base_url() ?>purchase/dashboard/<?= $type ?>/<?= $stvl->pm_purchaseid ?>"  class="text-info"><i class="fas fa-edit"></i> Edit</a>
                                                    <?php } ?> <br/>
                                                    <?php 
                                                    if($type == 0)
                                                    {
                                                    ?>
                                                    <a href="<?= base_url() ?>purchase/dashboard/0/<?= $stvl->pm_purchaseid ?>/1" class="text-secondary"><i class="fas fa-undo"></i> Return</a>
                                                    <?php 
                                                    }
                                                    }else{
                                                    ...
                                                    ?>
                                                    <a href="<?= base_url() ?>purchase/confirmdashboard/0/<?= $stvl->pm_purchaseid ?>" class="text-secondary"><i class="fas fa-comment"></i> Confirm Order</a>
                                                    <?php 
                                                        }
                                                    }
                                                    ?>
