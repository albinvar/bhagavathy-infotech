...
<div class="content-page">
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            ...
                            <a href="<?= base_url() ?>purchase/dashboard/1" class="ms-1 finyearaddbutton">
                                <button type="button" class="btn btn-primary waves-effect waves-light listbtns"><i class="fas fa-plus-circle"></i> Add Puchase Order</button>
                            </a>
                        ...
                        <div class="card-body">
                            ...
                            <script type="text/javascript">
                                function filterstockfun()
                                {
                                    ...
                                    window.location.href= '<?= base_url() ?>purchase/purchaseorderhistory/'+fromdate+'/'+todate;
                                }
                            </script>
                                    ...
                                    if($purchaselist)
                                    {
                                        ...
                                        foreach($purchaselist as $stvl)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= base_url() ?>purchase/purchaseprint/<?= $stvl->pm_purchaseid ?>/1" target="_blank" class="text-primary"><i class="fas fa-print"></i> Print</a> &nbsp;
                                                    <a href="<?= base_url() ?>" onclick="return confirm('Are you sure?')" class="text-danger"><i class="fas fa-trash"></i> Delete</a>
                                                </td>
                                            </tr>
                                            <?php
                                            $k++;
    ...
    {
        $.ajax({
          url: '<?php echo site_url('purchase/getbillitemdetails/1') ?>',
          type: 'POST',
          dataType: 'html',
          data: {billid: billid},
        })
