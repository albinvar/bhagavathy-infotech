            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Products Utilization</h4>
                    </div>
                </div>
            </div>     
            <!-- end page title --> 
                            ...
                            <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                ...
                                <tbody>
                                    ...
                                    if($productlist)
                                    {
                                        ...
                                        {
                                            $totalpurchase = $this->purslv->gettotalpurchasecount($stvl->pd_productid);
                                            $totalsale = $this->retlslv->gettotalsalecount($stvl->pd_productid);
                                            ?>
                                            <tr <?php if($stvl->pd_stock <= $stvl->pd_stockthreshold){ ?> style="background-color: #fad2d2;" <?php } ?>>
                                               ...
                                               <!-- <td><?= $stvl->pd_hsnno ?></td>
                                                ...
                                                <td>
                                                    <a href="<?php echo site_url('inventory/productutilizehistory/' . $stvl->pd_productid); ?>" class="text-primary"><i class="fas fa-eye"></i> View</a>
                                                </td>
                                            </tr>
                                            <?php
                                            $k++;
