                ...
                <div class="col-12">
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <a href="javascript:void(0)" onclick="importproductfun()" class="ms-1">
                                <button type="button" class="btn btn-primary waves-effect waves-light listbtns"><i class="fa fa-upload"></i> Import Products</button>
                            </a>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <a href="<?= base_url() ?>inventory/products/0" class="btn <?php if($active == '0'){ echo "btn-primary"; }else{ echo "btn-light"; } ?> " data-toggle="tab">Active Products</a>

                                    <a href="<?= base_url() ?>inventory/products/1" class="btn <?php if($active == '1'){ echo "btn-primary"; }else{ echo "btn-light"; } ?>" data-toggle="tab">Deleted Products</a>
                                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?php if($stvl->pd_isactive): ?>
                                                        <a href="<?php echo site_url('inventory/enabledisableproduct/' . $stvl->pd_productid); ?>" class="text-success" onclick="return confirm('Are you sure?')"><i class="fas fa-check"></i> Enable</a>
                                                        <?php else: ?>
                                                        <a class="text-primary" href="<?php echo site_url('inventory/addproduct/' . $stvl->pd_productid); ?>"><i class="fas fa-pen"></i> Edit</a>
                                                    &nbsp;
                                                        <a href="<?php echo site_url('inventory/enabledisableproduct/' . $stvl->pd_productid .'/1'); ?>" onclick="return confirm('Are you sure?')" class="ml-2 text-danger"><i class="fas fa-times"></i> Disable</a>
                                                       <?php endif; ?>
                                                </td>
                                            </tr>
                                            <?php
