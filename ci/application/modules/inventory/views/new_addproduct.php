                                ...
                                <div class="proditemform" id="productitem1">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 frmcode">
                                            ...
                                            <label><input type="radio"  value="4" <?php if($profittyp == 4){ echo "checked"; }  ?> onclick="protypechangefun('1', this.value);retailamntcalculation('1');wholesaleamntcalculation('1')" name="profittype1"> Manual Entry</label>
            ...
            $('#productadddiv').append(`<div class="proditemform" id="productitem`+itmno+`">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 frmcode">
                                ...
                                <label><input type="radio"  value="4" <?php if($profittyp == 4){ echo "checked"; }  ?> onclick="protypechangefun('`+itmno+`', this.value);retailamntcalculation('`+itmno+`');wholesaleamntcalculation('`+itmno+`')" name="profittype`+itmno+`"> Manual Entry</label>
