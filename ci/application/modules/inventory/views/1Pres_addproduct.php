                                       ...
                                       <div class="col-md-2 frmcode">
                                        ...
                                        if($fourrate == 1)
                                        {
                                            ...
                                            <div class="col-md-2 frmcode">
                                                ...
                                                <input type="number" readonly="readonly" step="any" id="csaleamount1" value="<?= $csaleamnt ?>" class="form-control" name="csaleamount[]">
                                            </div>
                                            ...
                                            <div class="col-md-2 frmcode">
                                                ...
                                                <input type="number" readonly="readonly" step="any" id="dsaleamount1" value="<?= $dsaleamnt ?>" class="form-control" name="dsaleamount[]">
                                            </div>
                                            <?php
                                        }
                                        ?>
            ...
            $('#productadddiv').append(`<div class="proditemform" id="productitem`+itmno+`">
                        ...
                        <div class="row">
                            ...
                            if($fourrate == 1)
                            {
                                ...
                                <div class="col-md-2 frmcode">
                                    <label>C Sale Amount</label>
                                    <input type="number" readonly="readonly" step="any" id="csaleamount`+itmno+`" class="form-control" name="csaleamount[]">
                                </div>
                                ...
                                <div class="col-md-2 frmcode">
                                    <label>D Sale Amount</label>
                                    <input type="number" readonly="readonly" step="any" id="dsaleamount`+itmno+`" class="form-control" name="dsaleamount[]">
                                </div>
                                <?php
                            }
                            ?>
