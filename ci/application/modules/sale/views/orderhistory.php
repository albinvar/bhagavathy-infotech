                ...
                <div class="col-12">
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <!--<a href="<?= base_url() ?>sale/csvsalehistory/6/<?= $salesperson ?>/<?= $customer ?>/<?= $fromdate ?>/<?= $todate ?>" target="_blank" class="ms-1">
                             ...
                             <a href="<?= base_url() ?>sale/printsalehistory/6/<?= $salesperson ?>/<?= $customer ?>/<?= $fromdate ?>/<?= $todate ?>" target="_blank" class="ms-1">
                                <button type="button" class="btn btn-primary waves-effect waves-light listbtns"><i class="fas fa-print"></i> Print</button>
                            </a>  -->

                            <a href="<?= base_url() ?>sale/dashboard/6" class="ms-1 finyearaddbutton">
                                <button type="button" class="btn btn-primary waves-effect waves-light listbtns"><i class="fas fa-plus-circle"></i> Add New Order</button>
                            </a>
                        ...
                        <div class="card-body">
                            ...
                            <script type="text/javascript">
                                function filterstockfun()
                                {
                                    ...
                                    window.location.href= '<?= base_url() ?>sale/orderhistory/<?= $ordertype ?>/'+salesperson+'/'+customer+'/'+fromdate+'/'+todate;
                                }
                            </script>
                                        ...
                                        foreach($retaillist as $stvl)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    }else if($stvl->rb_orderstatus == 2)
                                                    {
                                                        echo "<br/><i>(Order Cancelled)</i>";
                                                    }else{
                                                    ?>
                                                    <a href="<?= base_url() ?>sale/dashboard/6/<?= $stvl->rb_retailbillid ?>"  class="text-secondary"><i class="fas fa-edit"></i> Edit</a> 
                                                    <br/>
                                                    <a href="<?= base_url() ?>sale/confirmdashboard/6/<?= $stvl->rb_retailbillid ?>" class="text-success"><i class="fas fa-check"></i> Confirm</a> &nbsp;

                                                    <a href="<?= base_url() ?>sale/cancelorderfun/<?= $stvl->rb_retailbillid ?>" onclick="return confirm('Are you sure?')" class="text-danger"><i class="fas fa-trash"></i> Cancel</a>
                                                    <?php 
                                                        }
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="standard-modalLabel">Order Item Details</h4>
