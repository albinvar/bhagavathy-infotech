...
<div class="content-page">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body p-2 dashoboardform">
                            <form action="<?= base_url() ?>sale/addingsalereturn" method="POST" name="purchaseform" id="purchaseform">
                                <input type="hidden" name="type" value="<?= $type ?>">
                                <input type="hidden" name="billid" value="<?= $billid ?>">
                            <div class="row">
                                <div class="col-md-6">
                                    <input type="hidden" name="billprefix" value="<?= $billprefix ?>">
                                    Bill No: <b><?= $billprefix ?></b><input type="text" name="billno" readonly value="<?php if(isset($editdata)){ echo $editdata->rb_billno; }else{ echo $billno; } ?>" class="inputfieldcss" style="width: 100px;">
                                    &nbsp; Bill Date: <b><?php echo date('d-m-Y', strtotime($editdata->rb_date)) ." " . date('H:i', strtotime($editdata->rb_time)); ?></b>, Bill No: <b><?php  echo $prevbillprefix; ?><?= $editdata->rb_billno ?></b>
                                </div>
                                <div class="col-md-6" align="right">
                                    <input type="date" name="saledate" value="<?php echo date('Y-m-d');  ?>" class="inputfieldcss" style="width: 150px;">

                                    <input type="time" name="saletime" value="<?php echo date('H:i'); ?>" class="inputfieldcss" style="width: 130px;">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-3 mt-2">
                                    ...
                                    <select class="w-100 inputfieldcss" name="salesperson">
                                        <?php 
                                        if($this->userrole == 2)
                                        {
                                            ?>
                                ...
                                <div class="col-md-3 mt-2">
                                    ...
                                    <input type="text" name="shippingaddress" placeholder="Shipping Address" value="<?php if(isset($editdata)){ echo $editdata->rb_shippingaddress; } ?>" class="w-100 inputfieldcss">
                                </div>
                                <?php 
                                ...
                                <div class="col-md-3 mt-2">
                                    ...
                                    <select name="godownid" class="w-100 inputfieldcss">
                                        ...
                                        if($godowns)
                                        {
                                            ...
                                            {
                                                ?>
                                                <option <?php if(isset($editdata)){ if($editdata->rb_godownid=$gdvl->gd_godownid){ echo "selected"; } } ?> value="<?= $gdvl->gd_godownid ?>"><?= $gdvl->gd_godownname ?> (<?= $gdvl->gd_godowncode ?>)</option>
                                                <?php
                                            }
                                        }
                                        ?>
                                    ...
                                    <select name="stateid" id="stateid" class="w-100 inputfieldcss">
                                        <option value="">Select State</option>
                                            ...
                                            if($states)
                                            {
                                                ...
                                                {
                                                    ?>
                                                    <option <?php if(isset($editdata)){ if($editdata->rb_state==$stval->id){ echo "selected"; } }else{ if($stval->id == '4028'){ echo "selected"; }} ?> value="<?= $stval->id ?>"><?= $stval->name ?></option>
                                                    <?php
                                                }
                                            }
                                            ?>
                                    ...
                                    <tbody id="itemlistbody">
                                        ...
                                        <tr id="prdrow<?= $itno ?>">
                                            ...
                                            <td>
                                                ...
                                                <br/>
                                                <input type="hidden" name="availablestck[]" value="<?= $editvl->pt_stock ?>" id="availablestck<?= $itno ?>">
                                                <span style="font-size: 11px; color: #F00;">Stock: <span id="availstock<?= $itno ?>"><?= $editvl->pt_stock  ?></span></span><br/>
                                                <span style="font-size: 11px; color: #F00;">Blnce: <span id="balancestock<?= $itno ?>"><?= $editvl->pt_stock + $editvl->rbs_qty ?></span></span>
                                            </td>
                            ...
                            <input type="hidden" name="oldprofitamnt" id="oldprofitamnt" value="<?php if(isset($editdata)){ echo $editdata->rb_totprofit; }else{ echo 0; } ?>">
                            ...
                            <table class="w-100 footrtable" cellspacing="5">
                                <tr>
                                    ...
                                    <td width="150px"><input type="number" step="any" onchange="calculatetotalamnt()" onkeyup="calculatetotalamnt()" name="freight" id="freight" value="<?php if(isset($editdata)){ echo $editdata->rb_freight; }else{ echo 0; } ?>" class="w-100 inputfieldcss"></td>
                                    <td align="right"></td>
                                    <td></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <?php
                                    $oldblnce = 0;
                                    if($editdata->rb_customerid != 0)
                                    {
                                        $custdet = $this->cstmr->getcustomerbalance($editdata->rb_customerid);
                                        $oldblnce = $custdet->ct_balanceamount;
                                    }

                                    $balanceamnt = $editdata->rb_paidamount + $oldblnce;

                                    $newblanceamnt = $balanceamnt-$editdata->rb_grandtotal;
                                    ?>

                                    
                                    <td><input type="number" step="any" readonly name="oldbalance" id="oldbalance" value="<?php if(isset($editdata)){ echo $oldblnce; }else{ echo 0; } ?>" class="w-100 inputfieldcss"></td>
                                </tr>
                                <tr>
                                    <td align="right"></td>
                                    <td></td>
                                    <td align="right">Grand Total: </td>
                                    <td><input type="number" step="any" readonly name="grandtotal" id="grandtotal" value="<?php if(isset($editdata)){ echo $editdata->rb_grandtotal; }else{ echo 0; } ?>" class="w-100 inputfieldcss"></td>
                                    <td align="right">Paid Amount</td>
                                    <td><input type="number" step="any" <?php if(isset($editdata)){ if($editdata->rb_existcustomer == 0){ ?> readonly <?php } }else{ ?> readonly <?php } ?>  name="paidamount" id="paidamount" onkeyup="calculatepaidamount()" onchange="calculatepaidamount()" value="<?php if(isset($editdata)){ echo $editdata->rb_paidamount; }else{ echo 0; } ?>" class="w-100 inputfieldcss">
                                ...
                                <tr>
                                    ...
                                    <td><input type="number" step="any" readonly name="balanceamnt" value="<?php if(isset($editdata)){ echo $newblanceamnt; }else{ echo 0; } ?>" id="balanceamnt" value="0" class="w-100 inputfieldcss">
                                        <input type="hidden" name="previousbalanceamnt" value="<?php if(isset($editdata)){ echo $editdata->rb_balanceamount; }else{ echo 0; } ?>">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="w-100 inputfieldcss" name="pagesize" id="pagesize">
                                            <option <?php if(isset($editdata)){ if($editdata->rb_pagesize==1){ echo "selected"; } } ?> value="1">A4</option>
                                            <option <?php if(isset($editdata)){ if($editdata->rb_pagesize==2){ echo "selected"; } } ?> value="2">A5</option>
                                            <option <?php if(isset($editdata)){ if($editdata->rb_pagesize==3){ echo "selected"; } } ?> value="3">Thermal</option>
                                        </select>
                                    </td>
    ...
    function calculatetotalamnt()
    {
        ...
        $('#paidamount').val(parseFloat(newgrandtotal));
        var balanceamount = (parseFloat(oldbalance)+parseFloat(newgrandtotal))-parseFloat(newgrandtotal);
