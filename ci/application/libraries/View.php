...
class View{
  ...
  public function __construct()
  {
    ...
    $this->_module= substr($this->_CI->router->fetch_directory(), 0, -1);
    //echo($this->_module);
  ...
  private function _yaml_configs()
  {
   ...
   // print_r($default_configs);
    //echo $this->_controller;
    $controller_configs = $this->_configs($this->_controller);
   // print_r($default_configs);
   // $controller_configs=isset($controller_configs[$this->_module][$this->_controller])?$controller_configs[$this->_module][$this->_controller]:$controller_configs;
//print_r($controller_configs);
