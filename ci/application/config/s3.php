...
$config['access_key'] = 'AKIAI3DUPFOSLENX7S3A';
...
$config['secret_key'] = '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';
...
$config['bucket_name'] = 'toggle-teesbucket';
